...
| x    | Proposals | Block proposal | Block proposal received            | BlockProposalReceived{height, hash, size, tx_count, validator}                                                 | proposals_block_proposal_received (counter)                              |
| x    |           |                | Block proposal sent                | BlockProposalSent{validator, height, size, tx_count}                                                           | proposals_block_proposal_sent (counter)                                  |
| x    |           |                | Block proposal evaluated           | BlockProposalEvaluated{height, hash, size, tx_count, validator, accept, reason}                                | proposals_block_proposal_accepted (counter)                              |
| x    |           |                |                                    |                                                                                                                | proposals_block_proposal_rejected (counter)                              |
| x    |           |                | Block proposal committed           | BlockCommitted{height, app_hash}                                                                               | proposals_block_committed (counter)                                      |
