...
import {CallMsg, IpcMsgKind, IpcEnvelope, ReceiptType, BottomUpMsgBatch, BottomUpMsgBatch, BottomUpCheckpoint, ParentFinality} from "../structs/CrossNet.sol";
...
library LibGateway {
    ...
    function sendReceipt(IpcEnvelope memory crossMsg, ReceiptType receiptType,  bool success, bytes memory ret) internal {
        ...
        commitCrossMessage(crossMsg.createResultMsg(receiptType, success, ret));
    }
