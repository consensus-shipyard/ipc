...
import {BottomUpCheckpoint, BottomUpMsgBatch, IpcMsg, ParentFinality} from "../structs/CrossNet.sol";
...
contract GatewayGetterFacet {
    ...
    function postbox(bytes32 id) external view returns (IpcMsg memory storableMsg, bool wrapped) {
