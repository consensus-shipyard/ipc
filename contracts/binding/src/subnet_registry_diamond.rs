...
pub mod subnet_registry_diamond {
    ...
    ///`ConstructorParams(address,address,address,bytes4[],bytes4[])`
    #[derive(
        Clone,
        ::ethers::contract::EthAbiType,
        ::ethers::contract::EthAbiCodec,
    ...
    pub struct ConstructorParams {
        ...
        pub subnet_getter_selectors: ::std::vec::Vec<[u8; 4]>,
        pub subnet_manager_selectors: ::std::vec::Vec<[u8; 4]>,
    }
}
