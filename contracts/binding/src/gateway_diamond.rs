...
pub mod gateway_diamond {
    ...
    ///`ConstructorParams((uint64,address[]),uint256,uint256,uint256,uint8,(uint256,address,bytes)[],uint16)`
    #[derive(
        Clone,
    ...
    pub struct ConstructorParams {
        ...
        pub min_collateral: ::ethers::core::types::U256,
