...
pub mod gateway_getter_facet {
    ...
    impl<M: ::ethers::providers::Middleware> GatewayGetterFacet<M> {
        ...
        pub fn get_incomplete_msg_batches(
            &self,
        ) -> ::ethers::contract::builders::ContractCall<M, ::std::vec::Vec<BottomUpMsgBatch>>
        {
            self.0
    ...
    impl ::ethers::core::abi::AbiDecode for GatewayGetterFacetCalls {
        fn decode(
            ...
            if let Ok(decoded) =
                <BottomUpMsgBatchPeriodCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
            ...
            if let Ok(decoded) =
                <GetBottomUpMsgBatchCurrentWeightCall as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                )
            {
            ...
            if let Ok(decoded) =
                <GetBottomUpMsgBatchInfoCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
                return Ok(Self::GetBottomUpMsgBatchInfo(decoded));
            }
            if let Ok(decoded) =
                <GetBottomUpMsgBatchSignatureBundleCall as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                )
            {
            ...
            if let Ok(decoded) =
                <GetBottomUpMsgRetentionHeightCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
            ...
            if let Ok(decoded) =
                <GetIncompleteMsgBatchHeightsCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
                return Ok(Self::GetIncompleteMsgBatchHeights(decoded));
            }
            if let Ok(decoded) =
                <GetIncompleteMsgBatchesCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
    ...
    impl ::core::fmt::Display for GatewayGetterFacetCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
                ...
                Self::BottomUpMsgBatchPeriod(element) => ::core::fmt::Display::fmt(element, f),
                ...
                Self::GetBottomUpMsgBatchInfo(element) => ::core::fmt::Display::fmt(element, f),
                Self::GetBottomUpMsgBatchSignatureBundle(element) => {
                    ::core::fmt::Display::fmt(element, f)
                }
                Self::GetBottomUpMsgRetentionHeight(element) => {
                ...
                Self::GetIncompleteMsgBatches(element) => ::core::fmt::Display::fmt(element, f),
    ...
    impl ::core::convert::From<GetBottomUpMsgBatchCurrentWeightCall> for GatewayGetterFacetCalls {
    ...
    impl ::core::convert::From<GetBottomUpMsgBatchSignatureBundleCall> for GatewayGetterFacetCalls {
        fn from(value: GetBottomUpMsgBatchSignatureBundleCall) -> Self {
            Self::GetBottomUpMsgBatchSignatureBundle(value)
        }
    }
    impl ::core::convert::From<GetBottomUpMsgRetentionHeightCall> for GatewayGetterFacetCalls {
    ...
    impl ::core::convert::From<GetIncompleteMsgBatchHeightsCall> for GatewayGetterFacetCalls {
    ...
    pub struct GetIncompleteMsgBatchHeightsReturn(pub ::std::vec::Vec<::ethers::core::types::U256>);
