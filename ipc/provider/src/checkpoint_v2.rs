...
pub struct BottomUpCheckpointManagerV2<T> {
...
impl<T: SignedHeaderRelayer> BottomUpCheckpointManagerV2<T> {
    pub async fn new(
        parent: Subnet,
        child: Subnet,
        cometbft_client: CometbftClient,
...
impl BottomUpCheckpointManagerV2<EthSubnetManager> {
...
impl<T: SignedHeaderRelayer> Display for BottomUpCheckpointManagerV2<T> {
...
impl<T: SignedHeaderRelayer + Send + Sync + 'static> BottomUpCheckpointManagerV2<T> {
