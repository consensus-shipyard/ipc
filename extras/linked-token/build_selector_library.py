...
def writeToFile(selector_storage_content):
    ...
    file_path = 'script/SelectorLibrary.sol'
...
def get_selectors(contract):
    ...
    print(["forge", "inspect", contract, "methodIdentifiers"])
    res = subprocess.run(
...
def main():
    contract_selectors = {}
    filepaths_to_target = [
        'src/lib/LibLinkedTokenStorage.sol',
        'src/LinkedTokenReplicaFacet.sol',
        'src/IpcContractFacet.sol',
        'src/USDCTest.sol',
        'src/LinkedTokenControllerFacet.sol',
        'src/LinkedTokenFacet.sol',
        'src/LinkedTokenDiamond.sol',
        '../../contracts/src/diamond/DiamondCutFacet.sol',
        '../../contracts/src/diamond/DiamondLoupeFacet.sol',
        '../../contracts/src/OwnershipFacet.sol',
     ]
