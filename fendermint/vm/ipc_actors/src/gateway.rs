...
pub mod gateway {
    ...
    impl ::core::convert::From<PropagateCall> for GatewayCalls {
    ...
    impl ::core::convert::From<SendCrossMessageCall> for GatewayCalls {
        fn from(value: SendCrossMessageCall) -> Self {
            Self::SendCrossMessage(value)
        }
    }
    impl ::core::convert::From<SetMembershipCall> for GatewayCalls {
