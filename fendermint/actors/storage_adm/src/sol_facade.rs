...
use storage_node_sol_facade::machine as sol;
use storage_node_sol_facade::machine::{listBuckets_0Call, listBuckets_1Call, Calls};
use storage_node_sol_facade::types::{Address as SolAddress, SolCall, SolInterface, H160};
...
// --- Copied from storage_node_actor_sdk --- //
