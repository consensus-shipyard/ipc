...
use storage_node_kernel_ops::RecallOps;
        ...
        + RecallOps,
{
    fn link_syscalls(linker: &mut Linker<K>) -> anyhow::Result<()> {
        ...
        linker.link_syscall(
            storage_node_syscalls::MODULE_NAME,
            storage_node_syscalls::DELETE_BLOB_SYSCALL_FUNCTION_NAME,
            storage_node_syscalls::delete_blob,
        )?;
