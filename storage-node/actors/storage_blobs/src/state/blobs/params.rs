...
impl AddBlobStateParams {
    pub fn from_actor_params(
        params: fendermint_actor_storage_blobs_shared::blobs::AddBlobParams,
        epoch: ChainEpoch,
...
impl DeleteBlobStateParams {
    pub fn from_actor_params(
        params: fendermint_actor_storage_blobs_shared::blobs::DeleteBlobParams,
        epoch: ChainEpoch,
    ) -> Self {
        Self {
            hash: params.hash,
...
impl SetPendingBlobStateParams {
    pub fn from_actor_params(
        params: fendermint_actor_storage_blobs_shared::blobs::SetBlobPendingParams,
    ) -> Self {
        Self {
            source: params.source,
            hash: params.hash,
...
impl FinalizeBlobStateParams {
    pub fn from_actor_params(
        params: fendermint_actor_storage_blobs_shared::blobs::FinalizeBlobParams,
        epoch: ChainEpoch,
    ) -> Self {
        Self {
            source: params.source,
