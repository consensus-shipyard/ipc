...
use fendermint_actor_storage_blobs_shared::operators::RegisterNodeOperatorParams;
...
use storage_services::node::{launch, NodeConfig};
...
async fn query_object(args: QueryObjectArgs) -> Result<()> {
    use fendermint_actor_storage_bucket::GetParams;
    use fendermint_rpc::message::GasParams;
