...
OBJECTS_IROH_V4_PORT=11204
OBJECTS_IROH_V6_PORT=11205

FENDERMINT_METRICS_HOST_PORT=9188
FENDERMINT_IROH_RPC_HOST_PORT=4919
FENDERMINT_IROH_V4_PORT=11214
FENDERMINT_IROH_V6_PORT=11215
...
cargo make --makefile infra/fendermint/Makefile.toml \
    ...
    -e OBJECTS_IROH_V4_PORT="${OBJECTS_IROH_V4_PORT}" \
    -e OBJECTS_IROH_V6_PORT="${OBJECTS_IROH_V6_PORT}" \
    -e FENDERMINT_METRICS_HOST_PORT="${FENDERMINT_METRICS_HOST_PORT}" \
    -e FENDERMINT_IROH_RPC_HOST_PORT="${FENDERMINT_IROH_RPC_HOST_PORT}" \
    -e FENDERMINT_IROH_V4_PORT="${FENDERMINT_IROH_V4_PORT}" \
    -e FENDERMINT_IROH_V6_PORT="${FENDERMINT_IROH_V6_PORT}" \
